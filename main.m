function main
    ...
    gui.out_panel = uipanel('Title','Output','Position',[0.26 0.01 0.48 0.94],...
        'BackgroundColor', 'w',...
        'BorderType', 'line',...
        'BorderWidth', 2,...
    ...
    gui.in_panel = uipanel('Title','Input','Position',[0.01 0.01 0.24 0.94],...
        'BackgroundColor', 'w',...
        'BorderType', 'line',...
        'BorderWidth', 2,...
        'HighlightColor', [0 0.7 0.2]);  
    ...
    gui.export_panel = uipanel('Title','Export','Position',[0.75 0.01 0.24 0.94],...
        'BackgroundColor', 'w',...
        'BorderType', 'line',...
        'BorderWidth', 2,...
        'HighlightColor', [0 0.7 0.2]);          
