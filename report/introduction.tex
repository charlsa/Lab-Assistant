...
\subsection{Method}
Matlabs tools for graphical user interfaces were used in conjuction with the GPIB-bus to create software for controling both input and output of an experiment, aswell as exporting the results in various ways.
