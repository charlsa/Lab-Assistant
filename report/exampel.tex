...
\begin{center}
	\begin{figure}[h]
		\fbox{\includegraphics[scale=0.45]{Figure/rc-circuit}}
		\caption{RC-circuit}
		\label{RCcircuit}
	\end{figure}
\end{center}
...
\begin{center}
	\begin{figure}[h]
		\fbox{\includegraphics{Figure/screenshot.png}}
...
\begin{center}
	\begin{figure}[h]
		\fbox{\includegraphics{Figure/stem.png}}
		\caption{stem graph}
		\label{stem}
	\end{figure}
\end{center}
...
\begin{center}
	\begin{figure}[h]
		\fbox{\includegraphics{Figure/bode.png}}
		\caption{Bode graph}
		\label{bode}
	\end{figure}
\end{center}
